...
import tw, { styled, css, keyframes } from 'twin.macro';
...
// Kita tidak menginject css langsung ke ServerRow untuk menghindari error prop
                                    ...
                                    <div css={tw`grid grid-cols-1 gap-2`}>
                                        {items.map((server, index) => (
                                            <AnimatedItem key={server.uuid} delay={index * 0.05}>
                                                <CardWrapper>
                                                    {/* Kita render ServerRow di dalam wrapper styling kita sendiri */}
                                                    <div css={tw`p-1`}>
